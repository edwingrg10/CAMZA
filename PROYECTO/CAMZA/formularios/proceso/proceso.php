...
<form id="msform" action="../../php/registroproceso.php" method="POST">
    ...
    <input id="otroImpulso" type="text" name="persona_otro" placeholder="¿Quién es ese otro?" />
  ...
  <fieldset>    
    ...
    <div class="ayuda2"><p>¿En qué etapa del consumo te encuentras?</p></div>
    <div class="cetapa" style="margin-top:40px;"><input type="radio" value="Etapa Experimental" name="etapa"></div><p class="etapa"><span style="font-weight:bold;">Etapa Experimental </span>(Consumo privado y por curiosidad de entender el mundo de las drogas).</p>
    <div class="cetapa"><input type="radio" value="Etapa Abuso-Social" name="etapa"></div><p class="etapa"><span style="font-weight:bold;">Etapa Abuso-Social </span>(Consumo en conjunto con otras personas, simplemente por buscar diversión).</p>
    <div class="cetapa"><input type="radio" value="Etapa Dependiente" name="etapa"></div><p class="etapa"><span style="font-weight:bold;">Etapa Dependiente </span>(Consumo diario y constante por necesidad, pero normalidad en las actividades del día).</p>
    <div class="cetapa"><input type="radio" value="Etapa Disfuncional" name="etapa"></div><p class="etapa" style="margin-bottom:10px;"> <span style="font-weight:bold;">Etapa Disfuncional</span> (Consumo descontrolado, sin límites, existencia de problemáticas interpersonales).</p>
  </div>     
    </div>
    ...
    <h3 class="fs-titlesub1">Transmite aquí lo que siente tu corazón</h3>    
    <h6 class="fs-titlesub2">Abre tu corazón, esta información no llegará a otras personas </h6>
